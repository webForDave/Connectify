...
class CustomUserDetailsSerializer(UserDetailsSerializer):
    class Meta(UserDetailsSerializer.Meta):
        ...
        fields = ['id', 'email', 'username', 'bio', 'date_joined', 'communities_created', 'communities_joined']
        model = User

class CustomRegularUserDetailsSerializer(ModelSerializer): # For unauthenticated users
    class Meta:
        model = User
